...
public class ForecastWeatherFragment extends Fragment {
    ...
    private AppCompatButton button_closeFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button_closeFragment = view.findViewById(R.id.button_closeFragment);

        button_closeFragment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getFragmentManager().beginTransaction().remove(ForecastWeatherFragment.this).commit();
            }
        });
